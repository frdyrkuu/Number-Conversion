...
<header>
    <nav>
        <a href="http://localhost/Convert%20Number/" id="logo" class="logo">frdyrkuu.</a>
        <ul>
...
<body>
    <div class="container" id="convert">
        ...
        <div class="card-convert">
            ...
            <form method="post">
                <input type="submit" name="again" value="Convert Again " class="btn-convertAgain" type="button">
            </form>
        </div>
        ...
        if (isset($_POST['again'])) {
            ...
            header('Location: http://localhost/Convert%20Number/');
        }
        ?>
